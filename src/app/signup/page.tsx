...
const page = async () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <PageTitle title="SIGN-UP" className="my-8 text-3xl" />
      <svg
      ...
      >
        ...
        <g>
          ...
          <g>
            <path
              id="uuid-00bc58e7-734f-4d7c-a085-03c0cd267642-55"
          ...
          />
          <path
            id="uuid-ece83039-1aa0-468e-a846-e0cb6ecd6032-56"
      ...
      <form
        action={signUp}
        className="max-w-[500px] mx-auto mt-12 flex flex-col items-center gap-4 border rounded-lg p-12"
      >
        <Logo/>
        <Label htmlFor="name">Your name</Label>

        <Input name="name" id="name" placeholder="Ofek Levy" />
        ...
        <Input
          ...
          id="email"
          required
          placeholder="ofekgever@gmail.com"
        />
        ...
        <Input
          ...
          placeholder="123456"
        />
        <Label>Job Seeker/Job poster?</Label>
        <RadioGroup name="type" defaultValue="jobSeeker">
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="jobSeeker" id="jobSeeker" />
            <Label htmlFor="Expense">Job seeker</Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="jobPoster" id="jobPoster" />
            <Label htmlFor="income">Job poster</Label>
          </div>
        </RadioGroup>

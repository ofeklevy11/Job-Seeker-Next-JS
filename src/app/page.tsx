import CarouselSize from "@/components/CarouselLandingPage";
  ...
  return (
    <>
      <div className=" max-w-[1220px] mx-auto">
        <main className="grid grid-cols-2 py-24">
          <div className="text-center flex flex-col gap-10 justify-center">
            ...
            <h4 className="text-xl">
              ...
              ambitions. Start your career journey with us!
            </h4>
            <Link href={"/job-seeker"}>
              <Button className="flex gap-2 items-center bg-green-500 hover:bg-green-500/65 mx-auto font-bold">
                {" "}
                Get started! <LandPlot />
              </Button>
            </Link>
          </div>
          <div>
        ...
        <main className="grid grid-cols-2 gap-12 my-24">
          <div className="flex flex-col gap-6">
            <h3 className="font-bold text-2xl">Why choose Job seeker?</h3>
            <ul className="flex flex-col gap-6 text-lg">
              <li>
                🌐 Extensive Job Listings: Access a vast database of job
                openings in various industries.
              </li>
              <li>
                🎯 Personalized Matches: Get job recommendations that perfectly
                match your profile.
              </li>
              <li>
                ⏱️ Quick Application: Apply to jobs in just a few clicks with
                our streamlined process.
              </li>
              <li>
                📈 Career Growth: Find jobs that offer excellent career growth
                opportunities.
              </li>
              <li>
                💬 Expert Advice: Get tips and insights from industry experts to
        ...
        <main className="grid gap-8 text-center">
          <div className="">
        ...
        <section>
          <PageTitle title="Testimonials" className="mb-10" />
        ...
        <section className="flex flex-col items-center gap-8">
          <PageTitle title="Top Companies Hiring Now" />
          <CarouselSize />
        </section>
        <section className="rounded-lg border p-8 bg-green-500/60 my-12 flex flex-col items-center gap-4">
          <PageTitle title="Ready to Take the Next Step?" />
          <p className="text-lg">
        ...
        <footer className="text-center py-10 flex flex-col gap-2 border rounded-lg mb-12">
          <p className="max-w-[500px] mx-auto leading-6">
            At Job Seeker, we are dedicated to connecting job seekers with the
          ...
          <Link href={"/job-seeker/contact-us"}>
          ...
          <p>
            Feel free to contact us at: support@jobseeker.com | Phone: (123)
            456-7890{" "}
          </p>
          <p>Job seeker &copy;</p>
        </footer>
